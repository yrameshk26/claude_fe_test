<script lang="ts" module>
	...
	import type { Props as SelectInputProps } from '../inputs/SelectInput.svelte'
...
{#if !isEditing}
	...
	>
		...
		<div class="flex items-center gap-1 text-sm">
			...
			{#if (options?.find((option) => option.value === value)?.label || value) && showCopyButton && !hideCopyButton}
