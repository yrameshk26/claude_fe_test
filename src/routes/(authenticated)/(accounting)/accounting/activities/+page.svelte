<script>
	...
	headerState.title = 'View Accounting Activities'

	import ViewActivities from '$lib/components/views/ViewActivities.svelte'
...
<ViewActivities key="accountingActivities" {data} />
